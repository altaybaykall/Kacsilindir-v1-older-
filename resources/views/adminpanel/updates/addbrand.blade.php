        ...
        <div class="form-group col-md-6 mr-3">
            <div class="row">
                <div class="panel-header mb-3 mt-2">
                    <h3 class="py-2 px-1 m-0">Yeni Marka Ekle</h3>
                </div>
                ...
                <form action="/brand/add" method="POST" id="brand-from" enctype="multipart/form-data">
                    @csrf

                    <div class="form-group col  ">

                        <label for="brandname" class="text-muted mt-2">Marka Adı giriniz</label>
                        <input name="brand" id="brandname" class="form-control col-lg-10" type="text" placeholder=""
                               autocomplete="off"/>
                        @error('brand')
                    ...
                    <div class="form-group col ">
                        <img id="preview-image" src="/images/600.jpg" alt="preview image"
