...
<div class="modelselect-main ">
    <span class="mb-2"> <h1 class="mb-2" style="font-size: 1.5rem;font-weight: 600;margin-bottom: 15px">En Yavaş Hızlanan Arabalar</h1> <small>(0-100 süresine göre)</small></span>
                ...
                <ul class="model-select-ul">
                    ...
                    <li style="flex-wrap: nowrap;">
                        <span style="color: darkred;font-weight: 600"> {{$m->hundred_sec}} </span> <span style="font-size: 0.9rem;color: goldenrod;font-weight: 500"> s </span>
