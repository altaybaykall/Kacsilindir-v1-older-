...
<div class="modelselect-main ">
    <span class="mb-2"> <h1 class="mb-2" style="font-size: 1.5rem;font-weight: 600;margin-bottom: 15px"> En Çok Yakan Arabalar</h1> <small>(100km'de ortalamaya göre)</small></span>
                ...
                <ul class="model-select-ul">
                    @foreach($car as $m)
                    <li>
                        <span style="color: darkred;font-weight: 600"> {{$m->fuel_cons_avg}} </span> <span style="font-size: 0.8rem;color: #8c7c50;font-weight: 500">L/100km </span>
    ...
    width: auto;
    max-width: 160px;" class="model-image" src="{{$m->getCarEconomy->picture}}">
