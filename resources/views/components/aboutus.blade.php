...
<div class="center">
    <div class="our-info">
        <div class="info-content">
            <p>Sitemizde yer alan tüm içerik bilgilendirme amaçlı olup sitemiz sorumlu tutulamaz. Katalog değerleri, firmaların yayınladığı kataloglardan derlenmiştir.
                Paylaşılan yakıt tüketim değerleri kullanıcıdan kullanıcıya değişebilir.
                Kullanıcıların paylaştığı tüm bilgilerin doğruluğu ve yayınlanması ile ilgili yasal yükümlülükler içeriği oluşturan kullanıcıya aittir<p>

        </div>


        <div class="my-content">
             <p class="mb-3">Developer</p>
            <p class="ppi">Altay Baykal</p>
    <p class="ppi mt-2">altaybaykall@gmail.com</p>
</div>

        <a href="/"> <img alt="logo" src="/images/logosiyah.png"> </a>
    </div>
