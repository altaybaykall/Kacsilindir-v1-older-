...
<header class="header-bar mb-0">
      ...
      <a href="/">
       <img alt="main-logo-ks" class = "main-logo" src="/images/logosmallbeyaz.png"></a>
                ...
                <div class="authed">
                        <button class="authed-button btn btn-dark noHover dropdown-toggle" type="button" id="menu1" data-toggle="dropdown">
                           ...
                           @if(Auth::user()->avatar !== '/images/profileiconblack.png')
                            <img alt="pp-user" class="authed-img"  src="{{Auth::user()->avatar}}">
                            @else
                               <img alt="pp-user-not" class="authed-img" src="/images/profileiconwhite.png" alt="pp" >
                               @endif
    ...
    <a class ="sidebar-a" href=/karsilastir>
        ...
        <div class="car-area">
            <div class="cararea-icon">
                ...
                <ul id="car-area-ul">
                    @foreach($sidebrands as $b)

                        @if($b->cars_count >= 1)
                        <li>
                            <a href="{{  route ('VehicleRoute',[$b->brand])  }}"> {{ ucfirst(trans($b->brand)) }}</a>
                        <span style="color:#5a5c5a">({{$b->cars_count}})</span>
                        </li>
                        @endif
                    @endforeach
                </ul>
