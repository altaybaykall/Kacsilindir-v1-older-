        ...
        <div class="accountCardBody">
            <form method='POST' action="/update">
                ...
                <ul class="infoTable">
                    <li>
                        <div>
                            <h3 style="margin-bottom: 25px">Eski Kullanıcı adı</h3>
                            <label> {{ Auth::user()->user_name}}</label>
                        </div>
                    </li>
                    <li>
                        <div>
                            <h3 style="margin-bottom: 25px">Yeni Kullanıcı Adı</h3>
                            <input  name="user_name" id="user_name" class="form-control" type="text"  autocomplete="off"  autofocus />
                            @error('user_name')
