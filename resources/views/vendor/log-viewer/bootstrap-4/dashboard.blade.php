...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-lg-9">
            ...
            <h3> <a style="color: dodgerblue; text-decoration: firebrick" href="{{ route('log-viewer::logs.list') }}" class="nav-link">
                    <i class="fa fa-archive"></i> Tüm Loglar
                </a></h3>
        </div>
    </div>
@endsection
