...
<div class="news-header ">
    ...
    <div class="nh-row col p-auto">

        <img style="height: 35px;width: auto;margin-right:15px;" src="{{$Brands->logo}}">
            <h2 style="font-size: 1.5rem;padding-top: 5px">{{$Brands->brand}}</h2>
...
<section class="section">
    <div class="container">
        <div class="row">
            <div class="news-main col-lg-8 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <a href="/haber/{{$lt->id}}"
                                   class="list-group-item list-group-item-action flex-column align-items-start">
                                    <div class="w-100 justify-content-between">
                                        <img src="{{$lt->image}}" alt="latest-newss-img" class="img-fluid float-left">
